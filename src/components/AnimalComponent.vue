...
$k-bounce-down: (0, 1, 2, 3, 4, 6, 7, 8, 9, $total-kf);
$k-bounce-up: (0.5, 1.5, 2.5, 3.5, 6.5, 7.5, 8.5, 9.5);
$k-attack-prep: 10;
...
$kf-eyelid: (
  (0, 3, 3.2, 10, $total-kf - 0.6): translateY(-120%) rotate(-30deg),
  (3.05, 3.18, 10.05, $total-kf - 0.8): translateY(0) rotate(0),
...
$kf-ear: (
  ...
  (4.8, 5, 5.2, 5.6): rotate(-10deg),
  $k-attack-prep: rotateX(20deg) rotate(-5deg),
  ($kap + 0.4, $kap + 0.8, $kap + 1.2, $kap + 1.6, $kap + 2): rotateX(-30deg) rotate(-30deg),
  ($kap + 0.6, $kap + 1, $kap + 1.4, $kap + 1.8, $kap + 2.2): rotateX(-20deg) rotate(-20deg),
);
...
$kf-tail-end: (
  ...
  ($kap + 0.8, $kap + 1.2, $kap + 1.6, $kap + 2): rotate(2deg),
);
...
.body {
  ...
  box-shadow: inset -15px 0 0 $color-body-dark;
}
...
.fur {
  ...
  top: 0;
  border-radius: 50%;
  background: linear-gradient(to top, $color-fur, white 40%, white 50%, $color-fur 75%);
  ...
  &:first-child {
    ...
    left: calc(50% - 55px);
    z-index: 1;
    box-shadow: inset 0 0 0 2px rgba(black, 0.2), 3px 0 15px rgba(black, 0.2);
    ...
    > .patch {
      ...
      &:before {
        ...
        box-shadow: 2px 0 $color-fur-edge;
        background: linear-gradient(-45deg, $color-fur-edge, $color-fur 9%, transparent 20%);
      ...
      &:after {
        ...
        box-shadow: 0 3px $color-fur-edge;
        background: linear-gradient(-37deg, $color-fur-edge, $color-fur 9%, transparent 20%);
  ...
  > .patch {
    ...
    &:before {
      background: linear-gradient(-30deg, $color-fur-edge, $color-fur 6%, white 55%, transparent);
    }
...
.face {
  ...
  &:before {
    ...
    height: 100%;
    width: 100%;
    background: radial-gradient(farthest-side, rgba(black, 0.6), transparent);
    z-index: -1;
    top: 20%;
    left: 0%;
  }
...
.eye {
  ...
  box-shadow: inset 0 0 0 3px $color-eye;
  background-image: radial-gradient(ellipse 5px 10px at 50% 65%, $color-eye 0%, $color-eye 99%, transparent 100%),
...
.tail {
  ...
  .body > & {
    ...
    &:after {
      background: linear-gradient(to bottom right, $color-body-dark, $color-body-dark 20%, $color-body, $color-body);
    }
  }
  ...
  &.-end {
    ...
    &:before {
      ...
      bottom: -15%;
      left: 30%;
      box-shadow: -20px -5px $color-body, 20px -5px $color-body;
    }
  }
...
.inner-leg {
  ...
  &:before {
    ...
    background-image: linear-gradient(to bottom, $color-body 0%, $color-body 50%, transparent 100%),
      linear-gradient(
        to right,
        transparent 0%,
        transparent 25%,
      ...
      linear-gradient(to top, $color-body-dark, $color-body, $color-body-light);
  }
}
...
html body {
  ...
  background-image: repeating-linear-gradient(
    ...
    repeating-linear-gradient(to bottom, $lighter, $lighter 1px, transparent 1px, transparent 30px);
