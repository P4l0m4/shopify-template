...
<template>
  <div class="search">
    ...
    <!-- <button class="search__filters" @click="displayOverlay = !displayOverlay">
      <img src="@/assets/icons/filters.svg" alt="" />
    </button> -->
    <Transition name="fade">
      <div class="search__overlay" v-if="displayOverlay">
        <button class="search__overlay__close" @click="displayOverlay = false">
          <img src="@/assets/icons/plus-dark.svg" alt="" />
        </button>
        <div class="search__overlay__group">
          <div
        ...
        <div class="search__overlay__group">
          Prix
          <div class="search__overlay__group__price">
            <button
              class="search__overlay__group__price__button"
              :class="{ 'search__overlay__group__price__button--selected': priceSortingSelected === 'high' }"
              @click="priceSortingSelected = 'high'"
            >
              <img class="icon" src="@/assets/icons/high.svg" alt="" />
            </button>
            <button
              class="search__overlay__group__price__button"
              :class="{ 'search__overlay__group__price__button--selected': priceSortingSelected === 'low' }"
              @click="priceSortingSelected = 'low'"
            >
